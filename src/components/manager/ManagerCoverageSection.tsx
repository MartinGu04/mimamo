...
function ShadowRow({ role, name }: { role: RoleName; name: string }) {
  return (
    <li className="flex flex-wrap items-center gap-1.5 rounded-md bg-overlay-soft px-2 py-1 text-xs ring-1 ring-border-strong">
...
function RoleNote({ role, coverage }: { role: RoleName; coverage: ManagerRoleCoverageRowView }) {
  ...
  return (
    <li className="rounded-md bg-overlay-faint px-2 py-1.5 ring-1 ring-border">
