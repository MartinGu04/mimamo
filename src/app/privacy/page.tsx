          ...
          <article>
            ...
            <section className="mt-6">
              ...
              <p className={`${P_CLASS} mt-3`}>
                עבור כל מכשיר שבו הופעלו התראות נשמר תיאור כללי בלבד, לצורך הצגת רשימת „המכשירים שלי” והסרת מכשיר:
                סוג המכשיר (טלפון/טאבלט/מחשב), מערכת ההפעלה, הדפדפן, והאם ההתראות הופעלו מתוך אפליקציה מותקנת. לא נשמרים
                מזהה דפדפן מלא (User-Agent), כתובת IP או טביעת אצבע דיגיטלית. בנוסף נשמרות חותמות זמן תפעוליות: מתי
                המכשיר נפתח לאחרונה, ומתי התקבלה בו בפועל התראה אחרונה -- „התקבלה” משמעו שההתראה הגיעה למכשיר והוצגה,
                ולא שהיא נקראה.
              </p>
            </section>
