          ...
          <article>
            ...
            <section className="mt-6">
              ...
              <ul className={UL_CLASS}>
                <li>פרטי חשבון Google המשמשים להתחברות, כגון כתובת דוא״ל, מזהה חשבון ותמונת פרופיל</li>
                <li>מידע על כוח אדם/סד״כ, הדרוש כדי להתאים בין החשבון המחובר לבין האדם המתאים בלוח</li>
                <li>שיבוצים, משמרות, תורנויות, מידע על זמינות/היעדרות ומידע תפעולי קשור</li>
                <li>תאריכים רלוונטיים לשירות/שחרור, במקומות שבהם תכונות האפליקציה נעזרות בהם</li>
                <li>מידע על מטווחים/הסמכות, במקומות שבהם תכונה זו בשימוש</li>
                <li>העדפות והיסטוריית התראות</li>
                <li>חותמת זמן של פעילות בלוח הבקרה, המשמשת להצגת מה השתנה מאז הביקור האחרון</li>
                <li>מידע על מנוי להתראות Push, במקומות שבהם תכונה זו הופעלה</li>
                <li>מידע על טוקן/פיד לסנכרון יומן, במקומות שבהם תכונה זו הופעלה</li>
              </ul>
            </section>
            ...
            <section className="mt-6">
              ...
              <ul className={UL_CLASS}>
                ...
                <li>Vercel -- אחסון (hosting) והרצה של האפליקציה</li>
            ...
            <section className="mt-6">
              ...
              <p className={P_CLASS}>
                האפליקציה משתמשת ב-Vercel Web Analytics לאיסוף נתוני שימוש מצטברים וסטטיסטיים בלבד. מחרוזת השאילתה
                (query string) וחלקי ה-fragment של כתובת העמוד מוסרים לפני שאירוע האנליטיקס נשלח, כך שפרטים המופיעים
                בכתובת אינם נכללים באירוע. האפליקציה אינה מצרפת ביודעין שם, דוא״ל או מזהה אישי אחר לאירועי האנליטיקס,
            ...
            <section className="mt-6">
              ...
              <p className={P_CLASS}>
                ...
                ההתראה עשוי לכלול מידע תפעולי, ובכלל זה פרטי משמרת או תורנות, ולעיתים שם של עמית לעבודה. בהתאם
                להגדרות המכשיר, מערכת ההפעלה או הדפדפן עשויים להציג את תוכן ההתראה גם כאשר המכשיר נעול.
              </p>
            </section>
